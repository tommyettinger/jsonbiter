...
public class TestNested extends TestCase {
    ...
    public static class TestObject3 {
        public com.github.tommyettinger.jsonbiter.output.TestNested.TestObject3 reference;
    }

    public void test_recursive_class() {
        // recursive reference will not be supported
        // however recursive structure is supported
        com.github.tommyettinger.jsonbiter.output.TestNested.TestObject3 obj = new com.github.tommyettinger.jsonbiter.output.TestNested.TestObject3();
