...
class CodegenImplArray {
    ...
    public static String genArray(ClassInfo classInfo) {
        ...
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter);");
        append(lines, "byte nextToken = com.github.tommyettinger.jsonbiter.CodegenAccess.readByte(iter);");
        append(lines, "if (nextToken != '[') {");
        append(lines, "if (nextToken == 'n') {");
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.skipFixedBytes(iter, 3);");
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter); return null;");
        append(lines, "} else {");
        append(lines, "nextToken = com.github.tommyettinger.jsonbiter.CodegenAccess.nextToken(iter);");
        append(lines, "if (nextToken == 'n') {");
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.skipFixedBytes(iter, 3);");
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter); return null;");
        append(lines, "}");
        ...
        append(lines, "}");
        append(lines, "com.github.tommyettinger.jsonbiter.CodegenAccess.unreadByte(iter);");
        append(lines, "{{comp}} a1 = {{op}};");
        append(lines, "if (!com.github.tommyettinger.jsonbiter.CodegenAccess.nextTokenIsComma(iter)) {");
        ...
        append(lines, "while (com.github.tommyettinger.jsonbiter.CodegenAccess.nextTokenIsComma(iter)) {");
        ...
        append(lines, "}");
//        append(lines, "if (c != ']') { com.github.tommyettinger.jsonbiter.CodegenAccess.reportIncompleteArray(iter); }");
    ...
    private static String genCollectionWithCapacity(Class clazz, Type compType) {
        StringBuilder lines = new StringBuilder();
        append(lines, "{{clazz}} col = ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter);");
        append(lines, "if (iter.readNull()) { com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter); return null; }");
        append(lines, "if (!com.github.tommyettinger.jsonbiter.CodegenAccess.readArrayStart(iter)) {");
        append(lines, "return col == null ? new {{clazz}}(0): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "}");
        append(lines, "Object a1 = {{op}};");
        append(lines, "if (com.github.tommyettinger.jsonbiter.CodegenAccess.nextToken(iter) != ',') {");
        append(lines, "{{clazz}} obj = col == null ? new {{clazz}}(1): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "obj.add(a1);");
        append(lines, "return obj;");
        append(lines, "}");
        append(lines, "Object a2 = {{op}};");
        append(lines, "if (com.github.tommyettinger.jsonbiter.CodegenAccess.nextToken(iter) != ',') {");
        append(lines, "{{clazz}} obj = col == null ? new {{clazz}}(2): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "obj.add(a1);");
        ...
        append(lines, "if (com.github.tommyettinger.jsonbiter.CodegenAccess.nextToken(iter) != ',') {");
        append(lines, "{{clazz}} obj = col == null ? new {{clazz}}(3): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "obj.add(a1);");
        append(lines, "obj.add(a2);");
        ...
        append(lines, "{{clazz}} obj = col == null ? new {{clazz}}(8): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "obj.add(a1);");
        append(lines, "obj.add(a2);");
        append(lines, "obj.add(a3);");
    ...
    private static String genCollectionWithoutCapacity(Class clazz, Type compType) {
        ...
        append(lines, "{{clazz}} col = ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.resetExistingObject(iter);");
        append(lines, "if (!com.github.tommyettinger.jsonbiter.CodegenAccess.readArrayStart(iter)) {");
        append(lines, "return col == null ? new {{clazz}}(): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "}");
        append(lines, "Object a1 = {{op}};");
        append(lines, "if (com.github.tommyettinger.jsonbiter.CodegenAccess.nextToken(iter) != ',') {");
        append(lines, "{{clazz}} obj = col == null ? new {{clazz}}(): ({{clazz}})com.github.tommyettinger.jsonbiter.CodegenAccess.reuseCollection(col);");
        append(lines, "obj.add(a1);");
        append(lines, "return obj;");
        append(lines, "}");
        append(lines, "Object a2 = {{op}};");
